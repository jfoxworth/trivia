...
class EnterQuestion extends React.Component 
{
  ...
  answerQuestion = ( answer ) => {
    ...
    if ( this.props.game.activeQuestion.answerOptions.includes( answer ))
    {
      ...
      <div className="ml-3">
        ...
        <Form.Group controlId="formBasicEmail">
          ...
          <Button variant="primary"
                  ...
                  onClick={ ()=>{ this.answerQuestion( $event.target.value ) } }>
            Submit Answer
          </Button>
        </Form>
...
export default connect(null, mapDispatchToProps)(EnterQuestion);